...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=.\\SqlExpress; Initial Catalog=AutoPecas;User Id=sa;Pwd=132");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Fornecedores>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Forneced__AA57D6B45C2E2D7F")
                    .IsUnique();

                entity.HasIndex(e => e.RazaoSocial)
                    .HasName("UQ__Forneced__448779F017CE5AEA")
                    .IsUnique();

                entity.HasIndex(e => e.UsuarioId)
                    .HasName("UQ__Forneced__2B3DE7B9228B036D")
                    .IsUnique();
            ...
            modelBuilder.Entity<Pecas>(entity =>
            {
                ...
                entity.HasIndex(e => e.Codigo)
                    .HasName("UQ__Pecas__06370DACBD262A81")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D10534F11530A5")
                    .IsUnique();
